...
export const CONFIG = {
  // Default models
  DEFAULT_METADATA_MODEL: "gpt-5.4",
  DEFAULT_SCRIPT_MODEL: "gpt-5.4",
  DEFAULT_SCRIPT_OUTLINE_MODEL: "gpt-5.4",
  DEFAULT_SCRIPT_CONTENT_MODEL: "gpt-5.4",
  DEFAULT_SCRIPT_REFINEMENT_MODEL: "gpt-5.4",
  DEFAULT_SCRIPT_DESCRIPTION_MODEL: "gpt-5.4",
